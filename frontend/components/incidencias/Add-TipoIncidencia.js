...
const AddTipoIncidencia = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch(`${backendUrl}/api/incidencia/registerTipoIncidencia`, {
                method: 'POST',
                headers: {
        ...
        <div>
            ...
            <div className="registration-container">
                <form id="register-form" onSubmit={handleSubmit}>
                    <h3 className="mb-4 text-center">Agregar Tipo de Incidencia</h3>
                    <div className="mb-3">
                        <input
                            type="text"
...
export default AddTipoIncidencia;